  ...
  return (
    <>
        <section className='w-full h-screen bg-cover bg-center flex items-center'
            ...
            <div className="ml-8 max-w-lg text-black mt-35">
                ...
                <p className="mt-4 text-xl max-w-md text-white">
                ...
                <div  className="mt-5 flex flex-col gap-6 text-white">
                  ...
                  <a href="#"  className="text-3xl font-bold text-white hover:text-yellow-300">
                    → BUY NOW
                  </a>
                </div>
            </div>
